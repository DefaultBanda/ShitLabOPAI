...
// Game states as string literals instead of a type
// "start" | "countdown" | "reaction" | "pitstop" | "result"
...
export default function PitStopChallenge() {
  ...
  const [tyreClickTimes, setTyreClickTimes] = useState({})
  const [tyreSequence, setTyreSequence] = useState([])
  ...
  const [stuckWheel, setStuckWheel] = useState(null)
  ...
  const handleReactionComplete = (reactionTime, earlyStart) => {
      ...
      <div className="dark:bg-gray-900 bg-gray-50 min-h-screen">
        <header className="bg-black text-white py-4 shadow-md">
          <div className="container mx-auto px-4 flex items-center justify-between">
            <h1 className="text-3xl font-bold">F1 Pit Stop Challenge</h1>
            <div>
            ...
            {gameState === "start" && (
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md mb-6">
                  ...
                  <h2 className="text-2xl font-bold mb-4 text-center">Welcome to the F1 Pit Stop Challenge!</h2>
