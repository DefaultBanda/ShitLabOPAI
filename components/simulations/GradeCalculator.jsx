...
export default function GradeCalculator() {
  const MODES = [
    { value: "final-required", label: "Grade Required on Final" },
    { value: "overall-after", label: "Overall Grade After Final" },
    { value: "final-test", label: "Final Counts as a Test" },
    { value: "multi-part", label: "Multi-part Final Average" },
    { value: "weight-points", label: "Weight of Final from Points" },
    { value: "dropped-tests", label: "Final Exam with Dropped Tests" },
    { value: "top-six", label: "Top 6 Average" },
  ]
