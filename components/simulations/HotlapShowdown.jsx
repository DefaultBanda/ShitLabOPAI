...
const TRACK_LAYOUTS = {
 ...
 melbourne: {
  ...
  miami: {
    path: [
      { x: 150, y: 250, type: "start" },
      { x: 220, y: 200, type: "curve" },
      { x: 340, y: 180, type: "curve" },
      { x: 460, y: 220, type: "curve" },
      { x: 480, y: 320, type: "curve" },
      { x: 420, y: 410, type: "curve" },
      { x: 300, y: 450, type: "curve" },
      { x: 200, y: 420, type: "curve" },
      { x: 160, y: 330, type: "curve" },
      { x: 150, y: 250, type: "finish" },
    ],
    width: 58,
    arrows: [
      { x: 185, y: 230 }, { x: 300, y: 190 }, { x: 440, y: 230 },
      { x: 460, y: 300 }, { x: 430, y: 380 }, { x: 320, y: 440 },
      { x: 220, y: 400 }, { x: 170, y: 310 },
    ],
    startPosition: { x: 150, y: 250 },
  },
  imola: {
    path: [
      { x: 140, y: 270, type: "start" },
      { x: 200, y: 200, type: "curve" },
      { x: 320, y: 170, type: "curve" },
      { x: 420, y: 210, type: "curve" },
      { x: 470, y: 300, type: "curve" },
      { x: 430, y: 380, type: "curve" },
      { x: 310, y: 430, type: "curve" },
      { x: 200, y: 420, type: "curve" },
      { x: 150, y: 340, type: "curve" },
      { x: 140, y: 270, type: "finish" },
    ],
    width: 58,
    arrows: [
      { x: 175, y: 235 }, { x: 280, y: 185 }, { x: 420, y: 235 },
      { x: 450, y: 320 }, { x: 410, y: 370 }, { x: 290, y: 420 },
      { x: 210, y: 395 }, { x: 165, y: 315 },
    ],
    startPosition: { x: 140, y: 270 },
  },
  montreal: {
    path: [
      { x: 130, y: 220, type: "start" },
      { x: 220, y: 180, type: "curve" },
      { x: 340, y: 170, type: "straight" },
      { x: 460, y: 220, type: "curve" },
      { x: 470, y: 320, type: "curve" },
      { x: 420, y: 410, type: "curve" },
      { x: 300, y: 460, type: "curve" },
      { x: 180, y: 440, type: "curve" },
      { x: 130, y: 340, type: "curve" },
      { x: 130, y: 220, type: "finish" },
    ],
    width: 58,
    arrows: [
      { x: 165, y: 200 }, { x: 300, y: 175 }, { x: 450, y: 240 },
      { x: 455, y: 300 }, { x: 430, y: 380 }, { x: 320, y: 440 },
      { x: 210, y: 455 }, { x: 150, y: 360 },
    ],
    startPosition: { x: 130, y: 220 },
  },
  barcelona: {
    path: [
      { x: 150, y: 260, type: "start" },
      { x: 240, y: 190, type: "curve" },
      { x: 360, y: 180, type: "straight" },
      { x: 470, y: 230, type: "curve" },
      { x: 480, y: 330, type: "curve" },
      { x: 420, y: 410, type: "curve" },
      { x: 300, y: 450, type: "curve" },
      { x: 200, y: 430, type: "curve" },
      { x: 160, y: 340, type: "curve" },
      { x: 150, y: 260, type: "finish" },
    ],
    width: 60,
    arrows: [
      { x: 190, y: 230 }, { x: 320, y: 190 }, { x: 450, y: 250 },
      { x: 460, y: 310 }, { x: 430, y: 390 }, { x: 310, y: 440 },
      { x: 220, y: 420 }, { x: 175, y: 320 },
    ],
    startPosition: { x: 150, y: 260 },
  },
  budapest: {
    path: [
      { x: 150, y: 240, type: "start" },
      { x: 230, y: 190, type: "curve" },
      { x: 340, y: 170, type: "curve" },
      { x: 430, y: 210, type: "curve" },
      { x: 470, y: 300, type: "curve" },
      { x: 430, y: 380, type: "curve" },
      { x: 320, y: 430, type: "curve" },
      { x: 220, y: 420, type: "curve" },
      { x: 160, y: 340, type: "curve" },
      { x: 150, y: 240, type: "finish" },
    ],
    width: 55,
    arrows: [
      { x: 185, y: 210 }, { x: 310, y: 185 }, { x: 440, y: 235 },
      { x: 450, y: 320 }, { x: 410, y: 370 }, { x: 305, y: 420 },
      { x: 220, y: 400 }, { x: 175, y: 300 },
    ],
    startPosition: { x: 150, y: 240 },
  },
  zandvoort: {
    path: [
      { x: 160, y: 260, type: "start" },
      { x: 230, y: 210, type: "curve" },
      { x: 340, y: 190, type: "curve" },
      { x: 460, y: 230, type: "curve" },
      { x: 480, y: 320, type: "curve" },
      { x: 420, y: 400, type: "curve" },
      { x: 300, y: 440, type: "curve" },
      { x: 200, y: 420, type: "curve" },
      { x: 160, y: 340, type: "curve" },
      { x: 160, y: 260, type: "finish" },
    ],
    width: 60,
    arrows: [
      { x: 195, y: 230 }, { x: 320, y: 200 }, { x: 450, y: 240 },
      { x: 460, y: 300 }, { x: 430, y: 370 }, { x: 310, y: 420 },
      { x: 220, y: 400 }, { x: 185, y: 320 },
    ],
    startPosition: { x: 160, y: 260 },
  },
  baku: {
    path: [
      { x: 150, y: 210, type: "start" },
      { x: 230, y: 180, type: "curve" },
      { x: 360, y: 170, type: "straight" },
      { x: 470, y: 230, type: "curve" },
      { x: 480, y: 320, type: "curve" },
      { x: 420, y: 410, type: "curve" },
      { x: 300, y: 450, type: "curve" },
      { x: 180, y: 430, type: "curve" },
      { x: 150, y: 330, type: "curve" },
      { x: 150, y: 210, type: "finish" },
    ],
    width: 58,
    arrows: [
      { x: 180, y: 195 }, { x: 300, y: 175 }, { x: 450, y: 240 },
      { x: 460, y: 300 }, { x: 430, y: 380 }, { x: 320, y: 440 },
      { x: 200, y: 410 }, { x: 170, y: 310 },
    ],
    startPosition: { x: 150, y: 210 },
  },
  austin: {
    path: [
      { x: 140, y: 250, type: "start" },
      { x: 220, y: 190, type: "curve" },
      { x: 340, y: 170, type: "curve" },
      { x: 460, y: 220, type: "curve" },
      { x: 480, y: 320, type: "curve" },
      { x: 420, y: 410, type: "curve" },
      { x: 300, y: 460, type: "curve" },
      { x: 200, y: 440, type: "curve" },
      { x: 150, y: 350, type: "curve" },
      { x: 140, y: 250, type: "finish" },
    ],
    width: 60,
    arrows: [
      { x: 175, y: 220 }, { x: 300, y: 185 }, { x: 440, y: 230 },
      { x: 460, y: 300 }, { x: 430, y: 380 }, { x: 320, y: 440 },
      { x: 210, y: 420 }, { x: 170, y: 330 },
    ],
    startPosition: { x: 140, y: 250 },
  },
  mexico: {
    path: [
      { x: 150, y: 230, type: "start" },
      { x: 240, y: 180, type: "curve" },
      { x: 360, y: 170, type: "straight" },
      { x: 470, y: 240, type: "curve" },
      { x: 480, y: 330, type: "curve" },
      { x: 420, y: 420, type: "curve" },
      { x: 300, y: 460, type: "curve" },
      { x: 190, y: 440, type: "curve" },
      { x: 150, y: 340, type: "curve" },
      { x: 150, y: 230, type: "finish" },
    ],
    width: 58,
    arrows: [
      { x: 185, y: 200 }, { x: 300, y: 175 }, { x: 450, y: 250 },
      { x: 460, y: 310 }, { x: 430, y: 390 }, { x: 320, y: 440 },
      { x: 210, y: 455 }, { x: 170, y: 350 },
    ],
    startPosition: { x: 150, y: 230 },
  },
  saopaulo: {
    path: [
      { x: 160, y: 240, type: "start" },
      { x: 240, y: 190, type: "curve" },
      { x: 360, y: 180, type: "curve" },
      { x: 460, y: 230, type: "curve" },
      { x: 480, y: 320, type: "curve" },
      { x: 420, y: 390, type: "curve" },
      { x: 300, y: 430, type: "curve" },
      { x: 200, y: 410, type: "curve" },
      { x: 160, y: 330, type: "curve" },
      { x: 160, y: 240, type: "finish" },
    ],
    width: 58,
    arrows: [
      { x: 195, y: 215 }, { x: 320, y: 190 }, { x: 450, y: 240 },
      { x: 460, y: 300 }, { x: 430, y: 360 }, { x: 310, y: 420 },
      { x: 220, y: 400 }, { x: 185, y: 310 },
    ],
    startPosition: { x: 160, y: 240 },
  },
  lasvegas: {
    path: [
      { x: 150, y: 210, type: "start" },
      { x: 230, y: 170, type: "curve" },
      { x: 350, y: 170, type: "straight" },
      { x: 460, y: 220, type: "curve" },
      { x: 480, y: 330, type: "curve" },
      { x: 420, y: 420, type: "curve" },
      { x: 300, y: 450, type: "curve" },
      { x: 190, y: 430, type: "curve" },
      { x: 150, y: 320, type: "curve" },
      { x: 150, y: 210, type: "finish" },
    ],
    width: 60,
    arrows: [
      { x: 180, y: 190 }, { x: 300, y: 175 }, { x: 450, y: 240 },
      { x: 460, y: 310 }, { x: 430, y: 390 }, { x: 320, y: 440 },
      { x: 210, y: 420 }, { x: 170, y: 310 },
    ],
    startPosition: { x: 150, y: 210 },
  },
  losail: {
    path: [
      { x: 160, y: 230, type: "start" },
      { x: 240, y: 180, type: "curve" },
      { x: 360, y: 170, type: "straight" },
      { x: 470, y: 220, type: "curve" },
      { x: 480, y: 310, type: "curve" },
      { x: 420, y: 400, type: "curve" },
      { x: 300, y: 440, type: "curve" },
      { x: 200, y: 420, type: "curve" },
      { x: 160, y: 330, type: "curve" },
      { x: 160, y: 230, type: "finish" },
    ],
    width: 58,
    arrows: [
      { x: 195, y: 205 }, { x: 320, y: 185 }, { x: 450, y: 240 },
      { x: 460, y: 290 }, { x: 430, y: 370 }, { x: 310, y: 420 },
      { x: 220, y: 400 }, { x: 185, y: 310 },
    ],
    startPosition: { x: 160, y: 230 },
  },
  abudhabi: {
    path: [
      { x: 150, y: 220, type: "start" },
      { x: 230, y: 180, type: "curve" },
      { x: 350, y: 170, type: "straight" },
      { x: 460, y: 230, type: "curve" },
      { x: 480, y: 320, type: "curve" },
      ...
      { x: 190, y: 430, type: "curve" },
      { x: 150, y: 330, type: "curve" },
      { x: 150, y: 220, type: "finish" },
    ],
    width: 60,
    arrows: [
      { x: 180, y: 200 }, { x: 300, y: 175 }, { x: 450, y: 240 },
      { x: 460, y: 300 }, { x: 430, y: 380 }, { x: 320, y: 440 },
      { x: 210, y: 420 }, { x: 170, y: 320 },
    ],
    startPosition: { x: 150, y: 220 },
  },
}
